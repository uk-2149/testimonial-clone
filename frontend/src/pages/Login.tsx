  ...
  const handleLogin = async(e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        const res = await axios.post<{token: String}>(
            "http://localhost:5000/api/auth/logi",
            {
                email,
                password
            }
...
>
  <h2 className="text-3xl font-bold text-blue-400 text-center mb-2">Welcome Back</h2>
  <p className="text-sm text-gray-400 text-center mb-4">Login to manage your testimonials</p>
